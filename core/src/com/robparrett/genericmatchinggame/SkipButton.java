 ...
 */
public class SkipButton extends TextButton {
    private GenericMatchingGame game;

    public SkipButton(GenericMatchingGame g) {
        super("Skip", new TextButton.TextButtonStyle(
        ...
        addListener(new InputListener() {
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                Gdx.app.log("DEBUG", "skipButton touchDown");
                return true;
            }
